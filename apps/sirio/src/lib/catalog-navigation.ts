...
export const catalogNavigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Badge", href: "/components/badge", icon: IconTag },
      ...
      { name: "Controlli", href: "/components/controls", icon: IconAdjustments },
      { name: "Input", href: "/components/input", icon: IconCursorText },
      { name: "Number Input", href: "/components/number-input", icon: IconPlusMinus },
      { name: "OTP Input", href: "/components/otp-input", icon: IconNumber123 },
      { name: "Password Input", href: "/components/password-input", icon: IconPassword },
      { name: "Composite Input", href: "/components/composite-input", icon: IconLink },
      { name: "Dialog", href: "/components/dialog", icon: IconWindowMaximize },
      { name: "Dropdown Menu", href: "/components/dropdown-menu", icon: IconMenu2 },
      { name: "Empty State", href: "/components/empty", icon: IconFolderOff },
      { name: "Field", href: "/components/field", icon: IconListDetails },
      { name: "Floating Navigation", href: "/components/floating-navigation", icon: IconNavigation },

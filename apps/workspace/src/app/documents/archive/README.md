...
Pagina Workspace dedicata ai documenti archiviati, disponibile tramite la capability server-side `canManageArchivedDocuments` e il permesso `documents:archive`.

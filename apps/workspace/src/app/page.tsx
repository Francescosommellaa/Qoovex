...
export default async function RootPage() {
  ...
  if (context.company) {
    ...
    return <WorkspacePage>
      <WorkspacePageHeader title={context.company.organization.name} description="Spazio Azienda per documentare e condividere i lavori con i clienti." action={<Link className={linkVariants({ variant: "primary" })} href="/job-sites">Gestisci cantieri</Link>} />

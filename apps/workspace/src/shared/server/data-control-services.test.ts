...
describe("data control services", () => {
  ...
  it("exports metadata without Blob keys, token hashes, raw tokens or email bodies", async () => {
    ...
    mocks.db.documentVersion.findMany.mockResolvedValue([{ id: "version-1", organizationId: "org-1", documentId: "doc-1", originalFileName: "doc.pdf", mimeType: "application/pdf", size: 1200, checksum: "sum", uploadedById: "user-1", reviewStatus: "CURRENT", reviewedById: "user-1", reviewedAt: now, reviewReason: null, createdAt: now, archivedAt: null }]);
    mocks.db.evidence.findMany.mockResolvedValue([{ id: "evidence-1", organizationId: "org-1", jobSiteId: "jobsite-1", workerId: null, checklistItemId: null, type: "FILE", title: "Foto collegata", description: null, sensitivity: "INTERNAL", reviewStatus: "RECORDED", origin: "DIRECT_UPLOAD", capturedAt: now, reviewedById: null, reviewedAt: null, reviewReason: null, originalFileName: "photo.jpg", mimeType: "image/jpeg", size: 200, createdById: "user-1", createdAt: now, updatedAt: now, archivedAt: null }]);

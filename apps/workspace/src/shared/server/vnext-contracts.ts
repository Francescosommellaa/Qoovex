...
export const initialAgreementPayloadSchema = z.object({
  schemaVersion: z.literal(VNEXT_SCHEMA_VERSION),
...
export const vnextActionInputSchema = z.discriminatedUnion("action", [
...
export type VNextActionInput = z.infer<typeof vnextActionInputSchema>;

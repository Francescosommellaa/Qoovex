...
const presets: Array<{ value: OrganizationAccessPreset; label: string; description: string; permissions: OrganizationPermission[] }> = [
  ...
  { value: "SITE_MANAGER", label: "Responsabile cantiere", description: "Accesso ai soli cantieri assegnati.", permissions: ["organization:read", "workers:read", "jobSites:read", "documents:read", "deadlines:read", "calendar:read", "checklists:read", "checklists:complete", "evidence:read", "evidence:upload"] },

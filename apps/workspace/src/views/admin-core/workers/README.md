...
I form raccolgono solo dati minimi operativi e non introducono campi sanitari o qualifiche legali automatiche. `Mansione` resta separata dal ruolo di accesso; dalla scheda si puo inviare un `COLLABORATOR` con preset `LIMITED_UPLOAD`, collegato automaticamente al profilo dopo l'accettazione. Gli altri preset vengono configurati dalla superficie account dedicata.

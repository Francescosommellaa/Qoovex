      ...
      <div className={styles.splitGrid}>
        <div className={styles.grid}>
          ...
          <WorkspacePanel title="Voci checklist" description="Completare una voce registra un'attivita, non una verifica normativa.">
            {!items.length ? <p className="text-muted-foreground">Nessuna voce checklist registrata.</p> : (
        ...
        <div className={styles.grid}>
          <WorkspacePanel title="Aggiorna checklist">
            {capabilities.canManageChecklists ? (
              ...
              <p className="text-muted-foreground">Il tuo ruolo puo leggere la checklist, ma non modificarla.</p>
            )}
          </WorkspacePanel>
          <WorkspacePanel title="Aggiungi voce">
            {capabilities.canManageChecklists ? (
              ...
              <p className="text-muted-foreground">Non puoi aggiungere voci con il ruolo corrente.</p>
            )}
          </WorkspacePanel>
        </div>
      </div>

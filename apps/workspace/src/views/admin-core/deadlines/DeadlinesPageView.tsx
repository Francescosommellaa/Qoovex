    ...
    <WorkspacePage>
      <WorkspacePageHeader
        ...
        action={<div className="flex flex-wrap gap-2">
          {returnToDashboard ? <Link className={buttonVariants({ variant: "outline" })} href="/dashboard">Torna alla Panoramica</Link> : <Link className={buttonVariants({ variant: "outline" })} href="/calendar"><IconCalendar />Apri calendario</Link>}

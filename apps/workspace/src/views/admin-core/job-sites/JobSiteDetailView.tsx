    ...
    <WorkspacePage>
      ...
      <div className={styles.grid}>
          <WorkspacePanel title="Documenti collegati">
            {!documents.length ? <p className="text-muted-foreground">Nessun documento collegato al cantiere.</p> : (
          ...
          <WorkspacePanel title="Scadenze registrate">
            {!deadlines.length ? <p className="text-muted-foreground">Nessuna scadenza collegata al cantiere.</p> : (
              <div className={styles.list}>

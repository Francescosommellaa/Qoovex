...
export function DocumentRequirementsPanel({
  ...
  if (!canManage) {
    return <p className={styles.muted}>I requisiti documentali sono gestiti da proprietario o amministratore. Qui vedi solo gli eventuali documenti mancanti nel tuo scope.</p>;
  }
  ...
  return (
    <div className={styles.list}>
      ...
      <div className={styles.list}>
        {pending === "load" ? <p className={styles.muted}>Caricamento requisiti...</p> : null}
        {!requirements.length && pending !== "load" ? <p className={styles.muted}>Nessun requisito configurato.</p> : null}

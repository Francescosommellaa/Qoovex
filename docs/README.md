...
La fonte primaria e il set numerato `00`-`43`.
...
43. `43_QOOVEX_ADMIN_OPERATIONS.md`: console interna, ruolo Operatore Qoovex, gestione utenti, supporto, registro errori e dev-auth locale.

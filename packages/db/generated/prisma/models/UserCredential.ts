...
export type UserCredentialWhereInput = {
  ...
  passwordResetRequired?: Prisma.BoolFilter<"UserCredential"> | boolean
...
export type UserCredentialScalarWhereWithAggregatesInput = {
  ...
  passwordResetRequired?: Prisma.BoolWithAggregatesFilter<"UserCredential"> | boolean
...
export type UserCredentialOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "passwordHash" | "passwordUpdatedAt" | "passwordResetRequired" | "createdAt" | "updatedAt", ExtArgs["result"]["userCredential"]>
...
export interface UserCredentialDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const userCredentialWithUserIdOnly = await prisma.userCredential.findMany({ select: { userId: true } })
   *
   */
   ...
   * const userCredentialWithUserIdOnly = await prisma.userCredential.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const userCredentialWithUserIdOnly = await prisma.userCredential.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface UserCredentialFieldRefs {
  ...
  readonly passwordResetRequired: Prisma.FieldRef<"UserCredential", 'Boolean'>

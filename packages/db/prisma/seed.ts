  ...
  const summary = await prisma.$transaction(async (tx) => {
    ...
    await tx.organizationMembership.createMany({
      data: [
        ...
        { id: "local_demo_membership_worker_legacy", organizationId: FIXTURE_ORGANIZATION_ID, userId: FIXTURE_USER_IDS.workerLegacy, role: "COLLABORATOR", preset: "LIMITED_UPLOAD", scopeMode: "ASSIGNED", permissionKeys: limitedUploadPermissions },
      ],
    });

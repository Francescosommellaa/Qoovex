...
export type QoovexMarkProps = SVGProps<SVGSVGElement> & {
  tone?: "ink" | "white";
};

export function QoovexMark({
  tone = "ink",
  width = 26,
  height = 26,
  ...props
}: QoovexMarkProps) {
  const foreground = tone === "white" ? "#ffffff" : "#111111";
  const inset = tone === "white" ? "#111111" : "#ffffff";

...
function TextareaGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "relative flex w-full flex-col rounded-xl border border-input bg-background/50 transition-colors focus-within:border-ring focus-within:ring-1 focus-within:ring-ring/30 dark:bg-input/30",
        className
      )}
      {...props}
    />
...
function TextareaCounter({
  ...
  return (
    <span
      ...
      className={cn(
        "font-accent text-[0.6875rem] font-medium tracking-wider select-none",

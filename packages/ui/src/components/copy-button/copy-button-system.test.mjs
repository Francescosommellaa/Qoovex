...
test("CopyButton composes IconButton material with a designed Copy Check Error transition", () => {
  ...
  assert.match(implementation, /data-slot="copy-button-icon-copy"/)
  assert.match(implementation, /data-slot="copy-button-icon-success"/)
  assert.match(implementation, /data-slot="copy-button-icon-error"/)
  assert.match(implementation, /<IconCopy aria-hidden="true"/)
  assert.match(implementation, /<IconCheck aria-hidden="true"/)
  assert.match(implementation, /<IconAlertCircle aria-hidden="true"/)

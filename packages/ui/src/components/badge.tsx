...
const badgeVariants = cva(
  "group/badge inline-flex w-fit shrink-0 items-center justify-center font-accent font-semibold tracking-wide whitespace-nowrap no-underline transition-all duration-200 ease-out focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/30 select-none aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:shrink-0 [a]:active:scale-[0.97] [button]:active:scale-[0.97] data-interactive:active:scale-[0.97]",
  {
    variants: {
      variant: {
        default:
        ...
        warning:
          "bg-warning/15 text-warning-emphasis border border-warning/25 focus-visible:ring-warning/25 [a]:hover:bg-warning/25 [button]:hover:bg-warning/25 data-interactive:hover:bg-warning/25",
        ghost:
